...
/*
	...
	private final static QName CURRENCYCONVERTOR_QNAME = new QName(
...
/*
	 * public CurrencyConvertor() { super(__getWsdlLocation(),
	 * CURRENCYCONVERTOR_QNAME); }
	 * 
	 * public CurrencyConvertor(WebServiceFeature... features) {
	 * super(__getWsdlLocation(), CURRENCYCONVERTOR_QNAME, features); }
	 * 
	 * public CurrencyConvertor(URL wsdlLocation) { super(wsdlLocation,
	 * CURRENCYCONVERTOR_QNAME); }
	 * 
	 ...
	 */
	/*
	 * @WebEndpoint(name = "CurrencyConvertorSoap") public CurrencyConvertorSoap
	 * getCurrencyConvertorSoap() { return super.getPort(new
	 * QName("http://www.webserviceX.NET/", "CurrencyConvertorSoap"),
	...
	public CurrencyConvertor getCurrencyConvertorSoap(
			WebServiceFeature... features) {
		return super.getPort(new QName("http://www.webserviceX.NET/",
				"CurrencyConvertorSoap"), CurrencyConvertor.class,
				features);
	}}

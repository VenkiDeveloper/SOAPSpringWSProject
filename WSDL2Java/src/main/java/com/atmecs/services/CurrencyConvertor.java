    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.atmecs.services.CurrencyConvertor.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.atmecs.services.CurrencyConvertor.class.getResource(".");
